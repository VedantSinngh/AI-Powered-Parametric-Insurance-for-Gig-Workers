...
async def _log_activity_and_check_zone(
    ...
    """Background task: insert activity log + refresh most serviced zone."""
    ...
    # Refresh most serviced zone from recent activity.
    ...
    if zone_counts:
        ...
        # Require enough logs, then choose the most serviced zone directly.
        if total >= 8:

...
async def admin_only(
    ...
    """Require admin role. For now, check email domain or specific emails."""
    # Simple admin check — in production, add an 'is_admin' field
    admin_emails = {"vedaantsinngh@gmail.com"}
    if partner.email not in admin_emails:
        raise HTTPException(
            status_code=status.HTTP_403_FORBIDDEN,

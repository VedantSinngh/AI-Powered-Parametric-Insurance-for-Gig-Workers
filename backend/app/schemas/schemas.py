...
class AdminRequestOTPRequest(BaseModel):
    email: str = Field(min_length=5, max_length=254)


class AdminRequestOTPResponse(BaseModel):
    otp_session_id: str
...
class UpdateUpiRequest(BaseModel):
    upi_handle: str = Field(min_length=3, max_length=100)


class UpdatePreferencesRequest(BaseModel):
    preferred_language: Optional[Literal["en", "hi", "ta", "te"]] = None
    auto_premium_deduction: Optional[bool] = None

...
import { EVENT_ICONS, type Payout } from "@/lib/mock-data";
  ...
  return (
    <div className="flex items-center gap-4 px-4 py-3 rounded-xl hover:bg-surface transition-colors cursor-pointer group">
      ...
      <div className="flex items-center gap-4 flex-shrink-0">
        ...
        {payout.provider && (
          <span className="px-2 py-0.5 text-[10px] rounded-full font-semibold uppercase bg-slate-100 text-slate-700">
            {payout.provider}
          </span>
        )}
